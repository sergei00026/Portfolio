(() => {
    ...
    (() => {
        ...
        function showScaleElements(selectorParent, selectors, duration = .3, speed = .2) {
            document.querySelectorAll(selectorParent);
        ...
        showScaleElements(".header", ".aboutme-page__point", .5, .5);
        window["FLS"] = true;
        isWebp();
        spollers();
        pageNavigation();
